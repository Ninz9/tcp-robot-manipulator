...
public class MessageValidator {
 ...
 MessageValidator(){
     ...
     response = new HashMap<String, Pair<Pattern, Integer>>(){
         {
             put("CLIENT_USERNAME", new Pair(Pattern.compile(".{0,18}"), 20));
             ...
             put("CLIENT_FULL_POWER",new Pair( Pattern.compile("FULL POWER"),12));
             put("CLIENT_MESSAGE",new Pair( Pattern.compile(".{1,98}"),100));
         }
     };
 }
